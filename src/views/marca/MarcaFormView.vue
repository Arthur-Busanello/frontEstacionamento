<template>
  ...
  <div class="input-group mb-3">
    <input type="text" class="form-control" v-if="form === undefined" v-model="marca.nome" placeholder="nome" aria-label="Recipient's username" aria-describedby="button-addon2">
    ...
    <router-link to="/marca"><button v-if="form === undefined" class="btn btn-outline-secondary" type="button" id="button-addon2">voltar</button></router-link>
  </div>
</template>
