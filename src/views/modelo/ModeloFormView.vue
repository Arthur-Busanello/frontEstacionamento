<template>
    ...
    <div class="input-group mb-3">
      ...
      <!-- <input type="text" class="form-control" v-if="form === undefined" v-marca="this.marca" placeholder="id" aria-label="Recipient's username" aria-describedby="button-addon2"> -->
